...
{{
  "제목": "문서 제목 (한 문장)",
  "요약": "검토 배경과 목적을 상세히 (2-3문장)",
  "배경목적": "왜 이 검토를 하는가 (노후화, 생방송 안정성 등 구체적 사유)",
  "비교대안": [
    {{"모델": "제품명/모델명 (예: DELL P2722H)", "사양특징": "모든 스펙을 상세히 (해상도, 밝기, 크기, 특징 등)", "수량": "수량 정보", "단가": "개당 가격", "가격": "총 가격 또는 '없음'"}},
    ...
  ],
  "선정권고": "최종 선정 제품과 이유를 상세히. {decision_hint}",
  "예산합계": "{money_str}",
  "증거": [{{"page": n, "quote": "..."}}]
}}

**주의사항**:
- 비교대안은 본문에 있는 모든 제품을 포함하고, 각 제품의 모든 스펙을 상세히 작성
- 모델명, 규격, 수량, 단가, 총 가격을 모두 기재 (본문에 있으면)
- 선정 제품이 정말 없으면 '없음', 있으면 반드시 상세히 기재
- 금액은 본문에서 재확인 (합계/총액/견적/개당 가격/총 가격 모두)
- JSON만 반환
"""
